...
<security_standards>
Governing Standards: OWASP Top 10 (2021+), OWASP API Security Top 10 (2023), SLSA framework for supply chain integrity. All backend code MUST be reviewed against these checklists.
...
Rules: Never break existing versions. Deprecate with `Sunset` header and minimum 6-month notice. Document all versions in OpenAPI spec.
</api_versioning>
