...
<security_standards>
Governing Standards: CIS Benchmarks (Docker, Kubernetes, AWS/Azure/GCP), NIST SP 800-190 (Container Security), NIST SP 800-204 (Microservices Security), SLSA framework for supply chain integrity.
...
- Observability: OpenTelemetry Collector for unified telemetry. Export to Grafana stack (Loki/Tempo/Mimir) or cloud-native backends.
</architecture_principles>
