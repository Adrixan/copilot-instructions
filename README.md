...
A comprehensive set of best practice instructions and examples to efficiently and securely develop across various architectures using GitHub Copilot. Optimized for Claude Opus 4.6.
...
- **Security by Default:** OWASP Top 10, CIS benchmarks, SLSA supply chain, SAST/DAST in CI, no hardcoded secrets, input validation, CSP
- **TDD Workflow:** Test-first for business logic, linting/validation for infrastructure
- **Type Safety:** TypeScript 5.6+ strict mode, Python 3.12+ type hints, Java 21 records, PHP 8.3+ strict types, Go generics
